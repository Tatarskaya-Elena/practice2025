...
def log_process_start_end(spark, name, start_time, end_time):
    log_data = [(name, start_time, end_time)]
    log_df = spark.createDataFrame(log_data, ["name","start_time", "end_time"])
